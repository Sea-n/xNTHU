...
CREATE TABLE posts (
	uid CHAR(4) PRIMARY KEY UNIQUE,  /* case insensitive */
	id INTEGER UNIQUE,
	...
	fb_likes INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE users (
	...
	stuid VARCHAR(87) PRIMARY KEY NOT NULL,  /* Max: 9 num */
	...
	approvals INTEGER DEFAULT 0 NOT NULL,
	rejects INTEGER DEFAULT 0 NOT NULL,
	current_vote_streak INTEGER DEFAULT 0 NOT NULL,
	highest_vote_streak INTEGER DEFAULT 0 NOT NULL,
	last_vote TIMESTAMP DEFAULT "2020-01-01 00:00:00" NOT NULL,
...
CREATE TABLE google_accounts (
	sub VARCHAR(32) PRIMARY KEY NOT NULL,
	email VARCHAR(360) NOT NULL,
	name VARCHAR(87) NOT NULL,
	picture VARCHAR(320) NOT NULL,
	given_name VARCHAR(87) DEFAULT '' NOT NULL,
	family_name VARCHAR(87) DEFAULT '' NOT NULL,
	locale VARCHAR(32) DEFAULT '' NOT NULL,
	stuid VARCHAR(87) DEFAULT '' NOT NULL,
	last_verify TIMESTAMP DEFAULT "2020-01-01 00:00:00" NOT NULL,
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL
);
