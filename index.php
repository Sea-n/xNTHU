...
<?php include('includes/nav.php'); ?>
		...
		<div class="ts container" name="main">
			...
			<div id="review-content" style="height: 320px; overflow-y: hidden;">
				...
				<ul>
					<li>2 分鐘至 10 分鐘：達到 2 個&nbsp;<button class="ts vote positive button">通過</button>&nbsp;且無&nbsp;<button class="ts vote negative button">駁回</button></li>
				...
				<ul>
					<li>3 分鐘至 30 分鐘：達到 2 個&nbsp;<button class="ts vote positive button">通過</button>&nbsp;且無&nbsp;<button class="ts vote negative button">駁回</button></li>
					<li>30 分鐘以後：<button class="ts vote positive button">通過</button>&nbsp;不少於&nbsp;<button class="ts vote negative button">駁回</button></li>
				</ul>
				<div class="ts negative raised compact segment">
					<h5>例外狀況</h5>
					<p>為避免非法文章意外通過，每天 03:00 - 09:00 門檻提升為 <button class="ts vote positive button">通過</button> 需比 <button class="ts vote negative button">駁回</button> 多 2 個</p>
				</div>

				<h4>(C) 使用台灣 IP 位址</h4>
				<p>熱門投稿會快速登上版面，審核者們也有足夠時間找出惡意投稿，滿足以下條件即發出：</p>
				<ul>
					<li>5 分鐘至 1 小時：達到 3 個&nbsp;<button class="ts vote positive button">通過</button>&nbsp;且無&nbsp;<button class="ts vote negative button">駁回</button></li>
