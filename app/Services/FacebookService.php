...
class FacebookService extends BaseService implements PostContract
{
    ...
    public function __construct()
    {
        $this->tips_all = [
            ...
            env('APP_CHINESE_NAME') . " 有 50% 以上投稿來自交清 IP 位址",
            "登入後可看到 140.114.**.*42 格式的部分 IP 位址",
            ...
            "靠清 2.0 是由學生自行開發的系統，程式原始碼公開於 GitHub 平台\nhttps://git.io/" . env('APP_NAME'),
        ];
    }
