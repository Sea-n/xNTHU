...
<?php include('includes/nav.php'); ?>
		...
		<div class="ts container" name="main">
			...
			<p>不過有些投稿包含個人資訊，所以限制僅供已登入清大帳號的使用者才能檢閱。</p>

			<h2 class="ts header" id="apply-account">Q：怎麼註冊帳號</h2>
			<p>如果您是清大的學生、老師、校友，請直接點擊右上角 Login 使用 NCTU OAuth 登入，不需另外註冊即可使用。</p>
			<p>對於準清大生，靠北清大團隊特別提供帳號申請服務，不管您是百川、資工、電機特殊選才，還是碩班、博班正取生，只要憑相關證明私訊版主，即可幫您配發一個臨時帳號，正常使用此服務。</p>
			<p>但若您是友校學生、高三考生、其他親友，在這邊就只能跟您說聲抱歉了，目前不開放非清大使用者註冊，但您仍然可以正常投稿、瀏覽文章。</p>

			<h2 class="ts header" id="ip-mask">Q：隱藏 IP 位址的機制是什麼</h2>
			<p>所有已登入的清大人都看得到匿名發文者的部分 IP 位址，一方面知道幾篇文是同一個人發的可能性，另一方面又保留匿名性。</p>
			<p>對於大部分的位址，會使用 140.113.***.*87 (IPv4) 或 2001:288:4001:***:1234 (IPv6) 的格式，在無法追溯個人的前提下，盡可能提供最多資訊。</p>
			<p>其中 140.113.136.209 - 140.113.136.221 這段是<b>校內無線網路</b>的 IP 位址、140.113.0.229 是<b>清大 VPN</b> 的 IP 位址，一個人可以拿到多個 IP 位址、也會有非常多人拿到同一個位址。公開出來無法識別出個人，讓審核者們知道投稿者<b>不一定是清大師生</b>。</p>
