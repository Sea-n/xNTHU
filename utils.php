...
function idToDep(string $id): string {
	if (preg_match('#^1\d{2}\d{6}$#', $id)) {  # NTHU
		$TABLE = [ "0000"=>"清華學院學士班", "0001"=>"清華學院學士班", "0002"=>"清華學院學士班",  # 跨院系所
			...
			"0211"=>"數學系", "0212"=>"數學系", "0215"=>"數學碩", "0216"=>"數學碩", "0218"=>"數學博", "0222"=>"物理系",  # 理學院
			"0300"=>"工學院學士班", "0311"=>"材料系", "0312"=>"材料系", "0320"=>"化工系", "0325"=>"化工碩", "0328"=>"化工博", "0331"=>"動機系", "0332"=>"動機系", "0335"=>"動機碩", "0336"=>"動機碩", "0338"=>"動機博",  # 工學院
			"0410"=>"中文系", "0481"=>"人文社會學院學士班", "0482"=>"人文社會學院學士班",  # 人文社會學院
