...
function idToDep(string $id): string {
	if (preg_match('#^1\d{2}\d{6}$#', $id)) {  # NTHU
		$TABLE = [ "0000"=>"清華學院學士班", "0001"=>"清華學院學士班",  # 跨院系所
			"0100"=>"原科院學士班",  # 原子科學院
			"0211"=>"數學系", "0212"=>"數學系", "0222"=>"物理系",  # 理學院
			"0300"=>"工學院學士班", "0311"=>"材料系", "0312"=>"材料系",  # 工學院
			"0410"=>"中文系",  # 人文社會學院
			"0600"=>"電資學士班", "0611"=>"電機系", "0612"=>"電機系", "0621"=>"資工系", "0622"=>"資工系",  # 電機資訊學院
			"0625"=>"資工所", "0655"=>"資應所",  # 電機資訊學院
			"0700"=>"科管院學士班",  # 科技管理學院
			"0800"=>"生科院學士班",  # 生命科學院
			"0911"=>"教育科學系",  # 竹師教育學院
			"5910"=>"音樂學系",  # 藝術學院
	...
	$TABLE = [ "00000"=>"BEGIN",
		...
		"55201"=>"族文碩", "55401"=>"傳科系", "55501"=>"客家專班", "56001"=>"資科工碩", "56401"=>"國防資安專", "56501"=>"網工所", "56601"=>"多媒體所", "56701"=>"數據所", "56801"=>"資訊專", "57001"=>"生科碩", "57101"=>"分醫所碩", "57201"=>"生資所碩", "58001"=>"光電系統所", "58101"=>"照能所", "58201"=>"影生所", "58301"=>"光電專", "59001"=>"外語碩", "59101"=>"傳播碩", "59201"=>"應藝碩", "59301"=>"音樂碩", "59501"=>"建築碩", "59601"=>"教育碩", "59701"=>"社文碩", "59801"=>"英教碩", "59901"=>"亞際文化碩",
