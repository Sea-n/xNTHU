...
function idToDep(string $id): string {
	if (preg_match('#^1\d{2}\d{6}$#', $id)) {  # NTHU
		$TABLE = [ "0000"=>"清華學院學士班", "0001"=>"清華學院學士班", "0002"=>"清華學院學士班",  # 跨院系所
			...
			"0211"=>"數學系", "0212"=>"數學系", "0215"=>"數學碩", "0216"=>"數學碩", "0218"=>"數學博", "0221"=>"物理系", "0222"=>"物理系", "0225"=>"物理所",  # 理學院
			"0300"=>"工學院學士班", "0311"=>"材料系", "0312"=>"材料系", "0320"=>"化工系", "0325"=>"化工碩", "0328"=>"化工博", "0331"=>"動機系", "0332"=>"動機系", "0335"=>"動機碩", "0336"=>"動機碩", "0338"=>"動機博", "0340"=>"工工系",  # 工學院
			"0410"=>"中文系", "0465"=>"人類所", "0467"=>"人類所", "0445"=>"語言碩", "0481"=>"人文社會學院學士班", "0482"=>"人文社會學院學士班",  # 人文社會學院
			"0600"=>"電資學士班", "0611"=>"電機系", "0612"=>"電機系", "0621"=>"資工系", "0622"=>"資工系", "0623"=>"資工系",  # 電機資訊學院
			"0615"=>"電機所", "0616"=>"電機所", "0625"=>"資工所", "0626"=>"資工所", "0655"=>"資應所",  # 電機資訊學院
			"0700"=>"科管院學士班", "0721"=>"經濟系", "0722"=>"經濟系", "0745"=>"科法所", "0746"=>"科法所",  # 科技管理學院
			"0800"=>"生科院學士班", "0810"=>"生科系", "0820"=>"醫科系",  # 生命科學院
			"0911"=>"教科系", "0950"=>"特教系",  # 竹師教育學院
