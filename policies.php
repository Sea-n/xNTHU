...
?>
		<div class="ts container" name="main">
			...
			<p>隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，亦如另行登錄 NCTU OAuth、Google OAuth、Telegram、Facebook，或 Instagram 平台後的互動，依個別平台與使用者另訂的隱私條款，本網站的隱私政策也不適用於非本網站所委託或參與管理的人員。</p>
			...
			<p>本網站的網頁提供其他網站的網路連結，例如 NCTU OAuth、Google OAuth、Telegram、Facebook，或 Instagram 等外部平台，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站個別訂立的隱私權保護政策。</p>
