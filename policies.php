...
<?php include('includes/nav.php'); ?>
		...
		<div class="ts container" name="main">
			...
			<p>本網站的網頁提供其他網站的網路連結，例如 NCTU OAuth、Telegram、Twitter、Facebook、Instagram，或 Plurk 等外部平台，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站個別訂立的隱私權保護政策。</p>
